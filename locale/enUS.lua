...
L.filter_outOfMelee_desc = "This only considers what the threat API considers out of melee (i.e. more threat required to pull aggro). Active tanks are always in melee regardless of their distance to the target."
L.filter_hideOutOfMelee = "Hide players"
L.filter_desaturateOutOfMelee = "Desaturate players"
L.filter_desaturateStrengthOutOfMelee = "Desaturation Strength"
L.filter_desaturateStrengthOutOfMelee_desc = "0 means original color. 100 means completely grey."
